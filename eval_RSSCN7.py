...
from models.model_x4_R3 import Net as Mymodel_R3
from models.model_x4 import Net as Mymodel_x4
from models.model_x8 import Net as Mymodel_R4
...
#from data_x4 import get_eval_set
...
print(opt)
if opt.testBatchSize == 30:
    opt.output = '/home/zhangdy/SatelliteSR/Test/RSSCN7/Result'
cuda = opt.gpu_mode
...
if opt.scale == 4 or opt.scale == 8:
    if opt.testBatchSize == 30:
        opt.input_dir = '/home/zhangdy/SatelliteSR/Test/RSSCN7/Input_X4'
        #opt.input_dir = '/home/zhangdy/SatelliteSR/Test/RSSCN7/Input_X4_tt'
    else:
        opt.input_dir = '/titan_data1/lxy/dataset/Satellite_Imagery/RSSCN7/RSSCN7_LR/RSSCN7_LR_bicubic/X4'
if opt.scale == 2:
    if opt.testBatchSize == 30:
        opt.input_dir = '/home/zhangdy/SatelliteSR/Test/RSSCN7/Input_X2'
    else:
        opt.input_dir = '/titan_data1/lxy/dataset/Satellite_Imagery/RSSCN7/RSSCN7_LR/RSSCN7_LR_bicubic/X2'
...
model = VDSR()
#model = DDBPN(opt)
#model = Mymodel_x4(3, 64, opt.scale)#best result of mine for x4 and x8
#model = Mymodel_R4(3, 64, opt.scale)
#model = LGCNet()
#model = EEGAN(4)
#model = Mymodel_R3(3, 64, opt.scale)
#model = Mymodel(3, 64, opt.scale)# model_my_2 for x8 and x2
...
def eval():
    ...
    for batch in testing_data_loader:
            ...
            if opt.self_ensemble:
                ...
                with torch.no_grad():
                    if opt.model_type == 'SRFBN':
                        ...
                        #prediction,out2 = model(input) # for ECGAN
        ...
        #save_img(input.cpu().data, name[0])
